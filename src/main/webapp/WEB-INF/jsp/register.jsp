...
<body>
    ...
    <sf:form id="ussersForm" action="adduser" modelAttribute="user"
        ...
        <table width="500" border="0" cellpadding="4" cellspacing="1"
            ...
            <tr>
                ...
                <td witdth="270" align="left"><sf:input path="name"
                    size="28" id="name"/></td>
            </tr>
            <tr>
                <td colspan="2" algin="center"><sf:errors path="name" /></td>
            </tr>
            ...
            <tr>
                <td width="130" align="right"><s:message code="register.emai"/></td>
                <td witdth="270" align="left"><sf:input path="email" size="28" /></td>
            </tr>
            <tr>
                <td colspan="2" algin="center"><sf:errors path="email" /></td>
            </tr>
